# ============================================================
# PATH INJECTION FOR PORTABLE DEPLOYMENT
...
# Inject local_packages into sys.path (priority over system packages)
LOCAL_PACKAGES_DIR = os.path.join(BASE_DIR, 'local_packages')
if os.path.exists(LOCAL_PACKAGES_DIR):
    sys.path.insert(0, LOCAL_PACKAGES_DIR)
    print(f"[PATH] Injected local_packages: {LOCAL_PACKAGES_DIR}")

# ============================================================
# STANDARD IMPORTS (after path injection)
# ============================================================
...
# ============================================================
# ENVIRONMENT & APP INITIALIZATION (after imports)
# ============================================================
...
# Database file path
DB_PATH = os.path.join(DB_DIR, 'automation_progress.json')
